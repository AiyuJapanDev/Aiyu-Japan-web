...
import { getBlogPosts, getFeaturedBlogArticles } from "@/lib/strapi";
...
export async function loader({ params }: Route.LoaderArgs) {
  ...
  const featuredPosts = await getFeaturedBlogArticles(params.lang);
...
export default function Blog({ loaderData }: Route.ComponentProps) {
  ...
  const { posts, featuredPosts, currentPage, totalPages, locale } =
    loaderData as {
      posts: Article[];
