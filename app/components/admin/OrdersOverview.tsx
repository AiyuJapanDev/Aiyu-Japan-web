                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="awaiting_shipping_payment">
                                ...
                                {!order.is_rejected && (
                                  <div className="flex items-center gap-2 ml-3">
                                    ...
                                    <Select
                                      value={item.status}
                                      onValueChange={(value) =>
                                        updateProductStatus(item.id, value)
                                      }
                                    >
                                      ...
                                      <SelectContent>
                                        ...
                                        <SelectItem value="shipping_quoted">
                                          Shipping Quoted
                                        </SelectItem>
                                        <SelectItem value="shipping_paid">
                                          Shipping Paid
                                        </SelectItem>
