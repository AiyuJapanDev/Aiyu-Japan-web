...
const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  return (
    <div
      className={`${isMobile ? "fixed inset-y-0 left-0 z-50 w-64 bg-white/95 backdrop-blur-sm border-r border-blue-200 transform transition-transform duration-300" : "w-64 bg-white/90 backdrop-blur-sm border-r border-blue-200 min-h-screen"} ${isMobile && !sidebarOpen ? "-translate-x-full" : "translate-x-0"} p-6`}
    >
