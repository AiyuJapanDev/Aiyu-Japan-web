...
export const translations = {
  en: {
    ...
    personalShoppingTitle: "The best price-quality service on the market.",
    personalShoppingDescription:
      "Get premium benefits for <strong>¥500 per item</strong>, while others charge separate fees for each service.",
    ...
    expertKnowledge: "Free unlimited storage",
    accessExclusive: "Free consolidation",
    negotiation: "Free product photography request and more!",
    reducedCosts: "Reduced up to 40% on shipping costs",
    freeStorage: "No extra storage fee for previously received boxes.",
    professionalPackaging: "Double or normal packing",
    expressShipping: "Express shipping available",
    insuranceCoverage: "Insurance coverage - (not available for Paraguay)",
    realTimeTracking: "Get tracking of your orders!",
    ...
    // Storage Page
    volumetricW: "Volumetric weigth",
    dimensions: "Dimensions in cm (L x W x H)",
    ...
    volumetricWeightTooltip: "International shipments for air shipping to Paraguay and DHL use the higher of real weight or volumetric weight (L×W×H / 5000).",
    errorFetchingStorage: "Failed to load storage items",
    pending: "Pending",
    selected: "selected",
    quoteRequestedSuccess: "Shipping quote requested successfully!",
    // Storage Page
    ...
    optional: "optional",
    taxVatIdPlaceholder: "e.g., 2012345678",
    ...
    taxIdAlreadyRegistered: "Tax ID already registered",
    taxIdAlreadyInUse: "This tax/fiscal ID is already in use",
    ...
    statsTitle: "Dashboard – Aiyu Japan Analytics",
    statsSubtitle: "Summary of clients, orders and shipments",
    statsRefresh: "Refresh",
    statsViewOrders: "📦 Orders",
    statsViewShipping: "✈️ Shipping",
    statsTotalClients: "Total Clients",
    statsUsers: "Users",
    statsNewClients: "New Clients",
    ...
    statsLoyal: "Loyal +2 orders",
    statsOrdersByMonth: "Orders by Month",
    statsLast6Months: "Last 6 months",
    statsQuoteStatus: "Quote Status",
    statsBasedOnQuotes: "Based on quotes table",
    statsNewUsersByMonth: "New Users by Month",
    statsUserRegistration: "New customer registration",
    statsItemsByCountry: "Items Sold by Country",
    statsTop5Countries: "Top 5 countries",
    statsTopDestinations: "Top Destinations",
    statsTop5Destinations: "Top 5 destinations",
    statsShippingStatus: "Shipping Status",
    statsCurrentDistribution: "Current distribution",
    statsShippingsByMonth: "Shipments by Month",
    statsShippingMethods: "Shipping Methods",
    statsPopularityByMethod: "Popularity by method",
    statsWeightByCountry: "Total Weight Shipped by Country",
    statsInKilograms: "In kilograms",
    statsOrderList: "Order List",
    statsShippingList: "Shipping List",
    statsAllStatuses: "All Statuses",
    statsDateAll: "Date: All",
    statsToday: "Today",
    statsLast7Days: "Last 7 days",
    statsThisMonthFilter: "This month",
    statsThisYear: "This year",
    statsSearchOrdersPlaceholder: "Search by Order ID, Client, Aiyu ID...",
    statsSearchShippingPlaceholder: "Search by Shipping ID, Client, Aiyu ID...",
    statsOrderId: "Order ID",
    statsShippingId: "Shipping ID",
    statsAiyuId: "Aiyu ID",
    statsClientName: "Client",
    statsCountry: "Country",
    statsDate: "Date",
    statsStatus: "Status",
    statsAmount: "Amount",
    statsItemsCount: "Items",
    statsNoOrdersFound: "No orders found",
    statsNoShippingsFound: "No shipments found",
    statsShowing: "Showing",
    statsOf: "of",
    statsOrdersUnit: "orders",
    statsShipmentsUnit: "shipments",
    statsPrevious: "Previous",
    statsNext: "Next",
    statsItems: "Items",
    statsStatusPending: "Pending",
    statsStatusAwaitingShipping: "Awaiting Shipping",
    ...
    statsFilterDateRange: "Date Range",
    statsFilterLast30: "Last 30 days",
    statsFilterLast3Months: "Last 3 months",
    statsFilterThisYear: "This year",
  ...
  es: {
    ...
    personalShoppingTitle: "El mejor servicio calidad-precio del mercado.",
    personalShoppingDescription:
      "Obtén beneficios premium por <strong>¥500 por artículo</strong>, mientras que otros cobran tarifas separadas por cada servicio.",
    ...
    expertKnowledge: "Almacenamiento ilimitado gratuito",
    accessExclusive: "Consolidación gratuita",
    negotiation: "Solicitud de fotografía de producto gratuita y más!",
    reducedCosts: "Reducción de hasta el 40% en costos de envío",
    freeStorage:
      "Sin costo adicional de almacenamiento para cajas recibidas previamente.",
    professionalPackaging: "Embalaje doble o normal",
    expressShipping: "Envío express disponible",
    insuranceCoverage: "Cobertura de seguro - (no disponible para Paraguay)",
    realTimeTracking: "¡Obtén seguimiento de tus pedidos!",
    ...
    // Storage Page
    volumetricW: "Peso volumétrico",
    dimensions: "Dimensiones en cm (L x W x H)",
    ...
    volumetricWeightTooltip: "Los envíos internacionales para envío aéreo a Paraguay y DHL utilizan el mayor entre el peso real y el peso volumétrico (L×A×H / 5000).",
    errorFetchingStorage: "Error al cargar los artículos de almacenamiento",
    pending: "Pendiente",
    selected: "seleccionados",
    quoteRequestedSuccess: "¡Cotización de envío solicitada exitosamente!",
    ...
    // Statistics Dashboard
    statsTitle: "Dashboard – Aiyu Japan Analytics",
    statsSubtitle: "Resumen de clientes, ordenes y envíos",
    statsRefresh: "Actualizar",
    statsViewOrders: "👨‍💼📝 Ordenes",
    statsViewShipping: "✈️ Envíos",
    statsTotalClients: "Total Clientes",
    statsUsers: "Usuarios",
    statsNewClients: "Nuevos Clientes",
    statsThisMonth: "Este mes",
    statsOrders: "Pedidos",
    statsItemsSold: "Ítems Vendidos",
    statsPaid: "Pagados",
    statsShipments: "Envíos",
    statsRepeatClients: "Clientes Fieles",
    statsLoyal: "Fieles +2 ordenes",
    statsOrdersByMonth: "Pedidos por Mes",
    statsLast6Months: "Últimos 6 meses",
    statsQuoteStatus: "Estado de Cotizaciones",
    statsBasedOnQuotes: "Basado en la tabla de cotizaciones",
    statsNewUsersByMonth: "Nuevos Usuarios por Mes",
    statsUserRegistration: "Registro de nuevos clientes",
    statsItemsByCountry: "Ítems Vendidos por País",
    statsTop5Countries: "Top 5 países",
    statsTopDestinations: "Destinos Principales",
    statsTop5Destinations: "Top 5 destinos",
    statsShippingStatus: "Estado de Envíos",
    statsCurrentDistribution: "Distribución actual",
    statsShippingsByMonth: "Envíos por Mes",
    statsShippingMethods: "Métodos de Envío",
    statsPopularityByMethod: "Popularidad por método",
    statsWeightByCountry: "Peso Total Enviado por País",
    statsInKilograms: "En kilogramos",
    statsOrderList: "Lista de Pedidos",
    statsShippingList: "Lista de Envíos",
    statsAllStatuses: "Todos los Estados",
    statsDateAll: "Fecha: Todo",
    statsToday: "Hoy",
    statsLast7Days: "Últimos 7 días",
    statsThisMonthFilter: "Este mes",
    statsThisYear: "Este año",
    statsSearchOrdersPlaceholder: "Buscar por Pedido ID, Cliente, Aiyu ID...",
    statsSearchShippingPlaceholder: "Buscar por Envío ID, Cliente, Aiyu ID...",
    statsOrderId: "Pedido ID",
    statsShippingId: "Envío ID",
    statsAiyuId: "Aiyu ID",
    statsClientName: "Cliente",
    statsCountry: "País",
    statsDate: "Fecha",
    statsStatus: "Estado",
    statsAmount: "Monto",
    statsItemsCount: "Ítems",
    statsNoOrdersFound: "No se encontraron pedidos",
    statsNoShippingsFound: "No se encontraron envíos",
    statsShowing: "Mostrando",
    statsOf: "de",
    statsOrdersUnit: "pedidos",
    statsShipmentsUnit: "envíos",
    statsPrevious: "Anterior",
    statsNext: "Siguiente",
    statsItems: "Ítems",
    statsStatusPending: "Pendiente",
    statsStatusAwaitingShipping: "Esperando Envío",
    statsUnknown: "Desconocido",
    month0: "Ene", month1: "Feb", month2: "Mar", month3: "Abr", month4: "May", month5: "Jun",
    month6: "Jul", month7: "Ago", month8: "Sep", month9: "Oct", month10: "Nov", month11: "Dic",
    statsFilterDateRange: "Rango de Fechas",
    statsFilterLast30: "Últimos 30 días",
    statsFilterLast3Months: "Últimos 3 meses",
    statsFilterThisYear: "Este año",
    ...
    optional: "opcional",
    taxVatIdPlaceholder: "Ej: 2012345678",
    ...
    passwordRequirements: "La contraseña debe cumplir con:",
    ...
    phoneAlreadyInUse: "Este número de teléfono ya está en uso",
    taxIdAlreadyRegistered: "Número fiscal ya registrado",
    taxIdAlreadyInUse: "Este número fiscal ya está en uso",
