...
const JapaneseAddressCard: React.FC<JapaneseAddressCardProps> = ({ userId, username }) => {
        ...
        <Card className="max-w-4xl border border-gray-200 shadow-sm mt-5">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="border-t pt-3 text-sm text-muted-foreground">
                    <p className="font-semibold text-red-600 mb-1">{t("japaneseAddresswarningsTitle")}</p>
