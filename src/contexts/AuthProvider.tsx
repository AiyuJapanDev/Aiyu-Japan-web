...
import { fetchUserMeta } from './auth.utils';
import type { AuthContextType, UserRole, Profile } from './auth.types';
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const assignRole = async (userId: string, role: UserRole) => {
    ...
    if (error) {
      ...
      toast({ title: "Role assigned", description: `User role updated to ${role}` });
    }
    return { error };
  };
