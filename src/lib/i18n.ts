...
export const translations = {
  en: {
    ...
    heroDescription: "Get access to exclusive Japanese products with our reliable proxy shopping service. From anime merchandise to electronics and fashion.",
    ...
    step1DetailedDescription: "Send us the links (URLs) of the items you want to buy through any of our social media channels; if you prefer, we also accept a clear image of the product.",
    step2DetailedTitle: "Wait for the quote",
    step2DetailedDescription: "We'll verify availability and price, and prepare an electronic receipt with the total cost of your items.",
    step3DetailedTitle: "Pay for your purchases",
    step3DetailedDescription: "If you agree with the quote, pay the receipt. We accept credit/debit cards and PayPal.",
    step4DetailedTitle: "Wait for your products to arrive at our office",
    step4DetailedDescription: "Your purchases will arrive at our facilities in a few days; we'll notify you by message as soon as we receive them.",
    step5DetailedTitle: "Plan international shipping",
    step5DetailedDescription: "When all your items are with us, decide if you want to continue storing them to group more purchases or ship them immediately. (Check our calculator for reference prices per gram).",
    step6DetailedTitle: "Pay for shipping",
    step6DetailedDescription: "After weighing and consolidating the products, we'll send you the final receipt for international shipping.",
    step7DetailedTitle: "Receive your order",
    step7DetailedDescription: "With our express service, your package arrives in 1 to 2 weeks; economy shipping takes 2 to 3 weeks.",
  ...
  es: {
    ...
    heroDescription: "Accede a productos exclusivos japoneses con nuestro servicio confiable. Desde anime merch, electrónicos, figuras y moda — lo conseguimos y lo enviamos directo a tu país.",
    ...
    step1DetailedDescription: "Mándanos por cualquiera de nuestras redes sociales los enlaces (URL) de los artículos que deseas comprar; si lo prefieres, también aceptamos una imagen clara del producto.",
    step2DetailedTitle: "Espera la cotización",
    step2DetailedDescription: "Verificaremos disponibilidad y precio, y prepararemos un recibo electrónico con el costo total de tus artículos.",
    step3DetailedTitle: "Paga tus compras",
    step3DetailedDescription: "Si estás de acuerdo con la cotización, abona el recibo. Aceptamos tarjetas de crédito/débito y PayPal.",
    step4DetailedTitle: "Espera la llegada de tus productos a nuestra oficina",
    step4DetailedDescription: "Tus compras llegarán a nuestras instalaciones en pocos días; te avisaremos por mensaje apenas las recibamos.",
    step5DetailedTitle: "Planifica el envío internacional",
    step5DetailedDescription: "Cuando todos tus artículos estén con nosotros, decide si deseas seguir almacenándolos para agrupar más compras o enviarlos de inmediato. (Consulta nuestra calculadora para precios de referencia por gramo).",
    step6DetailedTitle: "Paga el envío",
    step6DetailedDescription: "Tras pesar y consolidar los productos, te enviaremos el recibo final correspondiente al envío internacional.",
    step7DetailedTitle: "Recibe tu pedido",
    step7DetailedDescription: "Con nuestro servicio exprés, tu paquete llega entre 1 y 2 semanas; el envío económico tarda de 2 a 3 semanas.",
    ...
    // Store names and descriptions
    amazonJapan: "Amazon Japón", amazonJapanDesc: "Una de las tiendas online Japonesas más famosas y confiables de todos.",
    rakuten: "Rakuten", rakutenDesc: "Una tienda conocida nacionalmente que se conoce por su variedad y precio.",
    yahooShopping: "Yahoo Shopping (PayPay Flea Market)", yahooShoppingDesc: "Tienda de ventas en general, similar a Amazon y Mercari.",
    mercariJapan: "Mercari Japón", mercariJapanDesc: "Tienda más grande de segunda mano. ¿Buscas una figura usada pero como nueva? Es aquí.",
    buyma: "Buyma", buymaDesc: "Marketplace japonés para ropa y artículos de marca exclusivos.",
    surugaya: "Surugaya", surugayaDesc: "Una de las tiendas más variadas y con los precios más baratos de artículos de anime.",
    mandarake: "Mandarake", mandarakeDesc: "La tienda perfecta para coleccionistas de manga, figuras y artículos retro.",
    animate: "Animate", animateDesc: "Una de las empresas de ventas de productos de anime más grandes de todas.",
    jumpShop: "Jump Shop", jumpShopDesc: "Artículos de One Piece, Haikyuu, Dragon Ball... ¿Ya conoces esta tienda?",
    chiikawaStore: "Chiikawa store", chiikawaStoreDesc: "Tienda oficial de Chiikawa con mercancía exclusiva y adorable.",
    cdJapan: "CD Japan", cdJapanDesc: "Japanese anime - J-pop groups - Kpop etc.",
    evangelionStore: "Evangelion Store", evangelionStoreDesc: "Tienda oficial de Evangelion con artículos exclusivos no disponibles en otras tiendas.",
    pokemonCenter: "Pokemon Center", pokemonCenterDesc: "Tienda oficial para todo tipo de productos de Pokémon, incluyendo peluches, ropa y juegos.",
    sailorMoonStore: "Sailor Moon Store", sailorMoonStoreDesc: "Encuentra productos exclusivos de Sailor Moon, desde figuras hasta artículos de colección.",
    sanrioStore: "Sanrio Store", sanrioStoreDesc: "Tienda oficial de Sanrio con productos adorables de Hello Kitty y otros personajes.",
    studioGhibliStore: "Studio Ghibli Store (Donguri Sora)", studioGhibliStoreDesc: "Tienda donde encontrarás productos exclusivos de las películas de Studio Ghibli.",
    usjStore: "Universal Studios Japan Store", usjStoreDesc: "Tienda oficial de Universal Studios Japan con productos exclusivos del parque.",
    disneyStore: "Disney Store", disneyStoreDesc: "Tienda oficial de Disney Japón con productos adorables y exclusivos.",
    mediaWorld: "Media World", mediaWorldDesc: "Especializada en figuras y mercancía de tus animes favoritos en segunda mano.",
    banpresto: "BANPRESTO", banprestoDesc: "Una de las mejores tiendas donde comprar tus figuras de anime.",
    popMart: "POP MART", popMartDesc: "La tienda de los Labubu, Crying Babies y más.",
    sylvanianFamilies: "Sylvanian Families", sylvanianFamiliesDesc: "Tienda oficial de los famosos ternurines, Sylvanian Family Store.",
    amiAmi: "AmiAmi", amiAmiDesc: "Una de las tiendas más populares de figuras y mercancía de anime. Amplia variedad de productos nuevos y en preventa.",
    goodSmileOnline: "Good Smile Online", goodSmileOnlineDesc: "Tienda oficial de Good Smile Company. Encuentra figuras Nendoroid, Figma y coleccionables exclusivos directamente del fabricante.",
    uniqlo: "UNIQLO", uniqloDesc: "Ropa cómoda y de calidad para toda la familia, con diseños simples y modernos.",
    gu: "GU", guDesc: "Moda asequible y a la moda, inspirada en las últimas tendencias de Japón.",
    zozotown: "ZOZOTOWN", zozotownDesc: "La tienda de moda online más grande de Japón con las mejores marcas.",
    graniph: "Graniph", graniphDesc: "Aquí encontrarás increíbles colaboraciones con series y animes.",
    weverseShop: "Weverse Shop Japan", weverseShopDesc: "Tienda oficial de productos K-pop en Japón.",
    btsOfficialShop: "BTS Official Shop Japan", btsOfficialShopDesc: "La tienda japonesa de una de las bandas más famosas del mundo.",
    newEra: "New Era", newEraDesc: "Gorras y accesorios de moda urbana de la marca New Era.",
    onitsukaTiger: "Onitsuka Tiger", onitsukaTigerDesc: "Zapatillas japonesas de moda con estilo retro y moderno.",
    crocsJapan: "Crocs Japan", crocsJapanDesc: "Tienda oficial japonesa de Crocs con nuevos modelos y colores.",
    humanMadeJapan: "Human Made Japan", humanMadeJapanDesc: "Ropa y accesorios de diseño creados por NIGO® y la marca Human Made.",
    adidasJapan: "Adidas Japan", adidasJapanDesc: "Tienda oficial de Adidas Japón con lanzamientos exclusivos.",
    nikeJapan: "Nike Japan", nikeJapanDesc: "Lo último en zapatillas, ropa y equipo deportivo de Nike en Japón.",
    stripeClub: "Stripe Club", stripeClubDesc: "Moda japonesa femenina con marcas como Earth, Music & Ecology.",
    daisoJapan: "Daiso Japón", daisoJapanDesc: "¿Tienda de 1 dólar? También lo tenemos.",
    nitori: "NITORI", nitoriDesc: "Una de las tiendas más grandes de Japón para comprar cosas para el hogar.",
    loft: "LOFT", loftDesc: "Tienda de productos de papelería, decoración y artículos para el hogar.",
    palCloset: "PAL CLOSET", palClosetDesc: "Una tienda donde encontrar cosas para la casa y ropa.",
    yodobashiCamera: "Yodobashi Camera", yodobashiCameraDesc: "Electrodomésticos, gadgets y artículos de hobby al mejor precio.",
    mujiJapan: "MUJI Japón", mujiJapanDesc: "Minimalismo japonés en su máxima expresión. Desde muebles y artículos del hogar hasta papelería, ropa y snacks.",
    oliveYoungGlobal: "Olive Young Global", oliveYoungGlobalDesc: "Tienda líder de cosmética coreana con envío global. Productos populares de skincare, maquillaje y cuidado personal.",
    cosmeCom: "Cosme.com", cosmeComDesc: "Una de las plataformas más confiables en Japón para comprar maquillaje y cosméticos de marcas japonesas premiadas.",

    // Shipping calculator regions
    asia: "Asia", europeCanadaMexico: "Europa, México y Canadá", usa: "EEUU", centralSouthAmerica: "Centro y Sur América",
