-- First, remove the default constraint on status column
...
-- Re-add the default value with the correct enum type
ALTER TABLE public.product_requests 
ALTER COLUMN status SET DEFAULT 'requested'::product_request_status;