-- ROLLBACK: Revert admin_cancel_order to original version
-- Use this ONLY if the emergency cancellation update causes issues
-- This restores the original behavior that blocks cancellation of paid orders
