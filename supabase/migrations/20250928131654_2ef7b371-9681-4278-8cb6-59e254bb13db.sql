...
DROP TRIGGER IF EXISTS clear_issues_on_approval ON shipping_quotes;

-- Create or replace the function to clear product issues when shipping quote is approved
